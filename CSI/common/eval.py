...
if P.ood_dataset is None:
    ...
    elif P.dataset == 'cifar10' or P.dataset == 'cifar100':
        P.ood_dataset = ['svhn', 'iSUN', 'LSUN_resize', 'Imagenet_resize', 'LSUN', 'Imagenet', 'LSUN_resize_fixed', 'Imagenet_resize_fixed']
    elif P.dataset == 'imagenet':
        P.ood_dataset = ['cub', 'stanford_dogs', 'flowers102', 'places365', 'food_101', 'caltech_256', 'dtd', 'pets']
    elif P.dataset == 'opencat-cifar10+':
        P.ood_dataset = ['opencat-cifar10+', 'opencat-cifar50+']
        is_open = True
    else:
        P.ood_dataset = [P.dataset]
        is_open = True
...
for ood in P.ood_dataset:
    ...
    if P.one_class_idx is not None:
        ...
        print("cur ood dataset: ", ood)
        ood_test_set = get_dataset(P, dataset=ood, test_only=True, image_size=P.image_size, eval=ood_eval, is_open=is_open)
