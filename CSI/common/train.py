...
if P.ood_dataset is None:
    if P.one_class_idx is not None:
        ...
        P.ood_dataset = ['svhn', 'LSUN_resize', 'Imagenet_resize', 'LSUN', 'Imagenet', 'cifar100']
...
#model = C.get_pred_layer(model, P.last_layer, P.n_classes)
#doing_soft = ('ratio' not in P.model)
#print("doing_softplus? ", doing_soft)
my_losses = Losses()
criterion = my_losses.get_loss_dict()[P.loss]
