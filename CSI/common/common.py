...
def parse_args(default=False):
    ...
    parser.add_argument('--model', help='Model',
                        choices=['resnet18', 'resnet18ratio','resnet18ratio2', 'resnet18ratiodre','resnet18spr','resnet18_imagenet'], type=str)
    parser.add_argument('--last-layer', help='Model',
                        choices=['ratio', 'linear'], type=str)
    parser.add_argument('--mode', help='Training mode',
                        default='simclr', type=str)
    parser.add_argument('--loss', help='Training mode',
                        default='ce', type=str)
    parser.add_argument('--lambd', help='beta-loss lambda',
    ...
    parser.add_argument('--save_step', help='Epoch steps to save models',
                        default=10, type=int)
    parser.add_argument('--seed', help='duhh',
                        default=0, type=int)
