...
class LVAE(nn.Module):
    def __init__(self, in_ch=3,
                 ...
                 dataset="MNIST", final_layer=None, classification_loss=None, args=None):
        super().__init__()
        self.in_ch = in_ch
        ...
        ## ugly add by WT
        self.classifier = final_layer(32, self.num_class)
        self.one_hot = nn.Linear(self.num_class, 32)
        self.pred_loss = classification_loss
    ...
    def lnet(self, x, y_de, args):
        ...
        predict = self.classifier(latent_y)
        predict_test = self.classifier(y_latent_mu)
