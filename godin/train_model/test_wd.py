...
def main():
    ...
    h_wd = weight_decay if 'linear' in layer_type else 0
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, (inputs, targets) in enumerate(train_data):
            epoch_bar.set_description(f'{epoch + 1}/{epochs}|loss{loss:0.2f}|bat{batch_idx + 1}/{num_batches}')
    ...
    outmodel_pth = os.path.join(model_dir,exp_name+'fixed_wd.pth')
