...
for name, param in model.bert.named_parameters():  
    ...
    if "encoder.layer.11" in name or "pooler" in name:# or "encoder.layer.10" in name:
...
def kliep_loss(logits, labels, max_ratio=15):
...
for epoch in trange(int(num_train_epochs), desc="Epoch"):
    ...
    if epoch % 3 == 0:
        ...
        cur_auc  = test_open_set_performance_gauss(model, test_dataloader, openset_dataloader, loss_type)
